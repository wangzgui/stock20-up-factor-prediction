"""
V5 offline validation: exactly 1,500 cold stocks per synchronous query,
20-day non-overlapping strategy anchors, three expanding time folds, and the
same local probability permutation that a rank-product submission would use.

This script reads train.csv only.  It never reads test.csv and never writes a
submission file.
"""
